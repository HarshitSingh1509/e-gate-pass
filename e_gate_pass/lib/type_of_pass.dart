...
class TypeofPass extends StatefulWidget {
  const TypeofPass({Key? key}) : super(key: key);

  @override
  _TypeofPassState createState() => _TypeofPassState();
}

class _TypeofPassState extends State<TypeofPass> {
