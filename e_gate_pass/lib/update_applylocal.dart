...
class UpdateApplyLocal extends StatefulWidget {
  String id;
  String gateid;
  UpdateApplyLocal(this.id, this.gateid);

  @override
  _UpdateApplyLocalState createState() => _UpdateApplyLocalState();
}

class _UpdateApplyLocalState extends State<UpdateApplyLocal> {
