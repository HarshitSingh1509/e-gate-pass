...
class colors {
  ...
  static const Color primary = Color(0xFF054c88);
  static const Color secondary = Color(0xff47D9B8);

  static Color get fontColor =>
      isDark == "true" ? secondary : const Color(0xff4543C1);
  static const Color grad1Color = Color(0xff7948BE);
  static const Color grad2Color = Color(0xff47D9B8);
  ...
  static const Color background = Color(0xffF3FCF8);
}
